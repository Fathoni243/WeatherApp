...
import fat.mobile.weatherapp.Retrofit.ApiService;
import fat.mobile.weatherapp.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public int CodeWeatherImage(int code) {
        ...
        switch (code) {
            case 0:
                generateCode = R.drawable.padang;
                break;
            case 1:
            case 2:
            case 3:
...
//                generateCode = "Kondisi belum ditambahkan";
    ...
    public String CodeWeather(int code) {
        ...
        switch (code) {
            case 0:
                binding.imgCrn.setImageResource(R.drawable.padang);
